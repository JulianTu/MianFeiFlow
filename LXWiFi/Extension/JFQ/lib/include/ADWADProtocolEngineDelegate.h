...
@interface ADWADProtocolEngineSelector : NSObject {
...
@protocol ADWADProtocolEngineDelegate
...
- (NSNumber *)getVideoAdvertisementListResponse:(NSNumber *)aRequestId withObject:(id)aResponseObject;

- (NSNumber *)getPopupAdvertisementListResponse:(NSNumber *)aRequestId withObject:(id)aResponseObject;

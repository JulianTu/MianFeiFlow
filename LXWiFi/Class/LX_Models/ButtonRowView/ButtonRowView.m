...
#define kButtonHeight                           62.0f
#define kImgOffy                                5.0f
...
-(UIView *)loadButtonViewWithFrame:(CGRect )frame imageStr:(NSString *)imageStr titleStr:(NSString *)titleStr textColor:(UIColor *)textColor count:(int)count tag:(int)tag{
    ...
    //下分隔线
    CALayer *bottomLayer = [self loadLayerWithFrame:CGRectMake(0.0f, frame.size.height - LineWidth *3, frame.size.width, LineWidth* 3)];
    bottomLayer.backgroundColor = textColor.CGColor;

...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _titleLab =[self loadLabelWith:CGRectMake(kOffX_float, 10.0, kmainScreenWidth -2*kOffX_float, 0) andText:@"" andTextColor:KBlockColor2_0 andFont:GetFont(14.0)];
       
        _contentLab =[self loadLabelWith:CGRectMake(kOffX_float, _titleLab.frame.origin.y +_titleLab.frame.size.height +cellSpace, kmainScreenWidth -2*kOffX_float, 0) andText:@"" andTextColor:kBlueTextColor andFont:GetFont(14.0)];
    }
    return self;
}

...
- (void)viewDidLoad
{
    ...
    headBar =[[HeadToolBar alloc] initWithTitle:@"选择截图" leftBtnTitle:@"返回" leftBtnImg:GetImage(@"back.png") leftBtnHighlightedImg:nil rightBtnTitle:nil rightBtnImg:nil rightBtnHighlightedImg:nil backgroundColor:kBlueTextColor];
